...
class FeatureMap_Attention_Neck(nn.Module):

    def __init__(self, in_channel, num_classes, embed_dim=256, num_layers=6):
        super(FeatureMap_Attention_Neck, self).__init__()
    ...
    def forward(self, inputs):
        ...
        bs = inputs.shape[0]
        transformer_inputs = inputs.view(bs, self.in_channel, -1).permute(0, 2, 1).contiguous()
