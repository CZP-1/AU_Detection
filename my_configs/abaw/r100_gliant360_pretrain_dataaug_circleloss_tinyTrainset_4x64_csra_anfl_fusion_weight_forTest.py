...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        data_prefix='/home/data/lrd/data/abaw/cropped_aligned',
        ann_file='/home/data/lrd/data/abaw/test_related/official_real_test_fake.txt',
        pipeline=test_pipeline,
        classes=classes
        ))
